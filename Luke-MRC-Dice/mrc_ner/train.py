...
from models.model_config import LukeForMrcNERConfig
from models.luke_mrc_ner import LukeForMrcNER



class LukeForMrcTask(pl.LightningModule):
    def __init__(self, args: argparse.Namespace):
        ...
        bert_config = LukeForMrcNERConfig.from_pretrained(self.model_path,
        ...
        self.model = LukeForMrcNER.from_pretrained(self.model_path, config=bert_config)
...
def main():
    parser = get_parser()
    parser = LukeForMrcTask.add_model_specific_args(parser)
    parser = Trainer.add_argparse_args(parser)
    args = parser.parse_args()

    task_model = LukeForMrcTask(args)
